  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <nav className="hidden md:flex sticky top-0 z-50 bg-white border-b border-slate-200 h-20 items-center justify-between px-8 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="h-12 w-12 rounded-2xl bg-secondary flex items-center justify-center">
            <span className="text-xl font-black text-primary uppercase">{merchant.username.charAt(0)}</span>
          </div>
          <div>
            <h1 className="text-xl font-black text-foreground tracking-tight leading-none">{merchant.businessName || merchant.username}</h1>
        ...
        <div className="flex items-center gap-6">
          <button 
            ...
            className="flex items-center gap-2 text-sm font-bold text-slate-600 hover:text-foreground"
          >
          ...
          <button 
            ...
            className="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-foreground hover:bg-slate-200"
          >
      ...
      <div className="max-w-7xl mx-auto pb-24">
        {/* ─── MOBILE HEADER ─── */}
        <header className="md:hidden sticky top-0 z-40 bg-slate-50/90 backdrop-blur-md pt-8 pb-4 border-none h-auto flex flex-col px-6 gap-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-black tracking-tight text-foreground">{merchant.businessName || merchant.username}</h1>
            ...
            <button 
              ...
              className="h-10 w-10 rounded-full bg-white flex items-center justify-center shadow-sm text-foreground"
            >
        ...
        {/* ─── SEARCH & FILTERS ─── */}
        <div className="px-6 md:px-8 pt-4 sticky top-[88px] md:top-20 bg-slate-50/90 backdrop-blur-md z-30 pb-4 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
          <div className="relative w-full md:max-w-md lg:max-w-xl shrink-0">
            ...
            />
            <button className="absolute right-3 top-1/2 -translate-y-1/2 h-8 w-8 bg-slate-50 rounded-full flex items-center justify-center hover:bg-slate-200 transition-colors">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-secondary text-white border-[#0D1B2E]" : "bg-white text-slate-500 border-slate-100 hover:bg-slate-50 hover:text-slate-700"
                  )}
                >
                  {filter}
                </button>
      ...
      {/* ─── MOBILE BOTTOM NAV ─── */}
      <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 bg-secondary/95 backdrop-blur-lg rounded-full px-6 py-3 shadow-2xl flex items-center gap-8 border border-white/10 z-50">
        <button className="h-10 w-10 bg-primary rounded-full flex items-center justify-center text-foreground shadow-md">
